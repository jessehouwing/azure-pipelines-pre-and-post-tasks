...
This extension contains patched versions of the "BashV3", "CmdLineV2" and "PowerShellV2" tasks. They are built from the latest release/mXXX brance of the [azure-pipelines-tasks](https://github.com/Microsoft/azure-pipelines-tasks) repository.
...
And you can find many other people who included [pre-](https://github.com/search/advanced?q=prejobexecution+filename%3Atask.json&type=Code) and [post-job](https://github.com/search/advanced?q=postjobexecution+filename%3Atask.json&type=Code) tasks in their extensions. I'm hoping these tasks will make the job of developing these extensions a little easier. And possibly will remove the need for these kinds of extensions for one-of scripts that need to run outside of the job context.
